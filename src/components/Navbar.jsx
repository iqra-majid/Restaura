...
const Navbar = () => {
  ...
  const handleScroll = (e, targetId) => {
    ...
    if (targetElement) {
      // provides the distance in pixels between the top edge of the target element
      // Subtract 80 of header
  ...
  return (
    <nav className="fixed top-4 z-50 flex w-full flex-col items-center justify-center">
      <div
       ...
       p-4 backdrop-blur-lg lg:m-2 lg:w-[50rem] lg:rounded-full shadow-lg"
      >
